...
function calculateOtherTaxable(lineItem) {
    let output = isNaN(parseFloat(lineItem.NETTAXABLEVALUE)) ? 0 : parseFloat(lineItem.NETTAXABLEVALUE);
...
module.exports = (invoice = invoiceSample) => {
    ...
    invoice.BILLTONAME = invoice.COMPANYGSTINADRESSES == null ? invoice.BILLTONAME : invoice.COMPANYGSTINADRESSES.ADDRESS;
