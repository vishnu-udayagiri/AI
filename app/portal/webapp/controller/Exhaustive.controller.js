sap.ui.define(
    ...
    function (Controller,
        ...
        return Controller.extend("airindiagst.controller.Exhaustive", {
            onAfterRendering: function () {
            },
            onInit: async function () {
                sap.ui.core.BusyIndicator.show();
                this.oRouter = this.getOwnerComponent().getRouter();
                this.oRouter.getRoute("Exhaustive").attachPatternMatched(this._routeMatched, this);
            ...
            _routeMatched: function (oEvent) {
                ...
                this.getOwnerComponent().getModel("shellModel").setProperty("/title", "Exhaustive Report");
            ...
            //for pnr number
             handleValueHelppnrNum: function (oEvent) {
                ...
                var filterJson;
                this.inputId = oEvent.getSource().getId();
                if (!this.pnrNumberDialog) {
                    this.pnrNumberDialog = sap.ui.xmlfragment("airindiagst.view.Fragment.PNRdetailsFIlterDialog", this);
                }
                this.getView().addDependent(this.pnrNumberDialog);
                jQuery.sap.syncStyleClass("sapUiSizeCompact", this.getView(), this.pnrNumberDialog);
                _self.getView().getModel("FilterDatamodel").refresh();
                _self.pnrNumberDialog.open();
            ...
            handleValueHelpClosepnrNum: function (oEvent) {
                ...
                //oEvent.getParameter("selectedContexts");
                if (oSelectedItem) {
                    var filterPnrnum = this.getView().byId(this.inputId);
                    filterPnrnum.setValue(oSelectedItem);
                }
            },
