sap.ui.define(
    ...
    function (Controller,
        ...
        return Controller.extend("airindiagst.controller.GSTInvoicesHistory", {
            ...
            onInit: async function () {
                ...
                this.oRouter.getRoute("GSTInvoicesHistory").attachPatternMatched(this._routeMatched, this);
                this.SendRequest = this.getOwnerComponent().SendRequest;
                this.apiType = "DocumentHistory";
                ...
                var oDateRangeSelection = this.getView().byId("fbdat-invoiceDate");
                var financialyear = this.getView().byId("fbdat-financialYear");
                var dateofissue = this.getView().byId("fbdat-DateofIssue");


                // Get the current date
                var currentDate = new Date();

                // Calculate the previous financial year's end date
                var currentYear = currentDate.getFullYear();
                var previousYear = currentYear - 1;
                var previousFinancialYearEndDate = new Date(previousYear, 2, 31); // March is month 2 (0-indexed)

                // Set the maxDate property of the DateRangeSelection control
                oDateRangeSelection.setMaxDate(previousFinancialYearEndDate);
                financialyear.setMaxDate(previousFinancialYearEndDate);
                dateofissue.setMaxDate(previousFinancialYearEndDate);
            },
            _routeMatched: function (oEvent) {
                ...
                this.getOwnerComponent().getModel("shellModel").setProperty("/title", "Document History");
            ...
            Fetch_GSTDetails: function () {
                ...
                filterval.apiType = "DocumentHistory";
                ...
                this.SendRequest(this, "/portal-api/portal/v1/get-user-invoices", "POST", {}, JSON.stringify(filterval), (_self, data, message) => {
                    ...
                    if (data) {
                        ...
                        // _self.byId("fbmc-GSTIN").setSelectedKeys(_self.defaultGSTN_num);  commented for passengergstin to searchhelp
            ...
            handleValueHelpSearchpassengergstin: function (oEvent) {
                ...
                if (invnoSH != "") {
                    this.SendRequest(this, "/portal-api/portal/v1/get-filter-data", "POST", {}, JSON.stringify({ "passengerGSTIN": invnoSH, "apiType": "DocumentHistory" }), (_self, data, message) => {
            ...
            onSearch: function (oEvent) {
                if (!this.getView().byId("filterbar").isDialogOpen()) {
                    ...
                    if (!oEvent) {
                        ...
                        // }  commented for change of passengergstin to searchhelp
            ...
            handleValueHelpSearchinvoiceNum: function (oEvent) {
                ...
                var invnoSH = oEvent.getParameter("value");
                if (invnoSH != "") {
                    this.SendRequest(this, "/portal-api/portal/v1/get-filter-data", "POST", {}, JSON.stringify({ "invoiceNumber": invnoSH, "apiType": "DocumentHistory" }), (_self, data, message) => {
            ...
            handleValueHelpSearchpnrNum: function (oEvent) {
                ...
                var invnoSH = oEvent.getParameter("value");
                if (invnoSH != "") {
                    this.SendRequest(this, "/portal-api/portal/v1/get-filter-data", "POST", {}, JSON.stringify({ "pnr": invnoSH, "apiType": "DocumentHistory" }), (_self, data, message) => {
            ...
            handleValueHelpSearchticketNum: function (oEvent) {
                ...
                var invnoSH = oEvent.getParameter("value");
                if (invnoSH != "") {
                    this.SendRequest(this, "/portal-api/portal/v1/get-filter-data", "POST", {}, JSON.stringify({ "ticketNumber": invnoSH, "apiType": "DocumentHistory" }), (_self, data, message) => {
            ...
            onPressExportExcel: function () {
                ...
                //var aSelectedIndices = oTable.getBinding().aIndices;
            ...
            handleValueHelpSearchbuyername: function (oEvent) {
                ...
                var invnoSH = oEvent.getParameter("value");
                if (invnoSH != "") {
                    this.SendRequest(this, "/portal-api/portal/v1/get-filter-data", "POST", {}, JSON.stringify({ "billToName": invnoSH, "apiType": "DocumentHistory" }), (_self, data, message) => {
            ...
            handleValueHelpSearchpassengername: function (oEvent) {
                ...
                var invnoSH = oEvent.getParameter("value");
                if (invnoSH != "") {
                    this.SendRequest(this, "/portal-api/portal/v1/get-filter-data", "POST", {}, JSON.stringify({ "passengerName": invnoSH, "apiType": "DocumentHistory" }), (_self, data, message) => {
